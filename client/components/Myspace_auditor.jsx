...
const Myspace_auditor = props => {
  return (
    <div className='flex flex-col text-lg h-max mb-10 item-center bg-gray-800 border shadow-lg shadow-blue-400 border-gray-700 p-6 m-6 rounded-md w-4/5 right-3/4'>
